...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaReceiverFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaReceiverFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNDIMediaReceiverFactory, UNDIMediaReceiverFactory::StaticClass, TEXT("UNDIMediaReceiverFactory"), &Z_Registration_Info_UClass_UNDIMediaReceiverFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNDIMediaReceiverFactory), 2644520492U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaReceiverFactory_h_1674807534(TEXT("/Script/NDIIOEditor"),
		Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaReceiverFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaReceiverFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
