...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaSenderFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaSenderFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNDIMediaSenderFactory, UNDIMediaSenderFactory::StaticClass, TEXT("UNDIMediaSenderFactory"), &Z_Registration_Info_UClass_UNDIMediaSenderFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNDIMediaSenderFactory), 740929165U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaSenderFactory_h_3696715904(TEXT("/Script/NDIIOEditor"),
		Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaSenderFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_owen_Documents_Unreal_Projects_plugin_build_test_Plugins_NDIIO_Source_Editor_Public_Factories_NDIMediaSenderFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
